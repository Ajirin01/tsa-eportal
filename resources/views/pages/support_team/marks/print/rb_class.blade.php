                        ...
                        <tbody>
                            <tr>
                                @for ($j = 0; $j < 20; $j++)
                                    ...
                                    @endphp
                                    <tr>
                                        <td style="height: 30px">{{ $data->lesson[$j] }}</td>
                                        {{-- <td style="height: 30px">{{$data->$ar0}}</td> --}}
                                        <td style="height: 30px">{{$data->$ar0}}</td>
                                        <td style="height: 30px">{{$data->$ar1}}</td>
                                        <td style="height: 30px">{{$data->$ar2}}</td>
                                        <td style="height: 30px">{{$data->$ar3}}</td>
                                        <td style="height: 30px">{{$data->$ar4}}</td>
                                    </tr>
                                @endfor
                            </tr>
