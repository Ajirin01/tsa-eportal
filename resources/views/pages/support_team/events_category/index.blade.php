...
@section('page_title', 'Manage Galleries Categories')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Manage Galleries Categories</h6>
            {!! Qs::getPanelOptions() !!}
        </div>

        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#all-categories" class="nav-link active" data-toggle="tab">Manage Galleries Categories</a></li>
            ...
            <div class="tab-content">
                        ...
                        <table class="table datatable-button-html5-columns">
                            ...
                            @foreach($events_category as $category)
                                <tr>
                                    ...
                                    {{-- <td>{{ $category->class_type->name }}</td> --}}
                                        ...
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left">
                                                    @if(Qs::userIsTeamSA())
                                                    {{--Edit--}}
                                                    <a href="{{ route('category.edit', $category->id) }}" class="dropdown-item"><i class="icon-pencil"></i> Edit</a>
                                                   @endif
                                                        @if(Qs::userIsSuperAdmin())
                                                    {{--Delete--}}
                                                    <a id="{{ $category->id }}" onclick="confirmDelete(this.id)" href="#" class="dropdown-item"><i class="icon-trash"></i> Delete</a>
                                                    <form method="post" id="item-delete-{{ $category->id }}" action="{{ route('category.destroy', $category->id) }}" class="hidden">@csrf @method('delete')</form>
                                                        @endif
                ...
                <div class="tab-pane fade" id="new-class">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form class="ajax-store" method="post" action="{{ route('category.store') }}" enctype="multipart/form-data">
